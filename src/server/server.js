    ...
    socket.on('pass', function(data) {
        if (data[0] === c.adminPass) {
            ...
            // TODO: Actually log incorrect passwords.
		            socket.emit('kick', 'Someone was messing with the admin console when they were not an admin. It was probably Jomes. Thanks, JOMES. Are you trying to ruin our fun, JOMES???!!!!!!!!!!!!!!!!');
            socket.disconnect();
